...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    @Override
    public void update(Integer categoryId, Category category) throws EtBadRequestException {

        try{
            jdbcTemplate.update(SQL_UPDATE, new Object[]{category.getTitle(), category.getDescription(), category.getUserId(), categoryId});
        }catch (Exception e){
            throw new EtBadRequestException("Invalid request");
        }
